 ...
 **/
public class _430FourHundredThirty {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new _430FourHundredThirty().flatten(node).toString());
        node = null;
        System.out.println(node == null);
        System.out.println(new _430FourHundredThirty().flatten(node) == null);
        node = new Node(new int[]{1, 2});
        node.child = new Node(3);
        System.out.println(node);
        System.out.println(new _430FourHundredThirty().flatten(node));
        node = new Node(1);
