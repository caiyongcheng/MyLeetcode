 ...
 * Difficulty: Hard
 * Link: https://leetcode.cn/problems/maximum-number-of-non-overlapping-substrings/
 *
 ...
 *
 * - The substrings do not overlap, that is for any two substrings s[i..j] and s[x..y] , either j < x
 * or i > y is true.
 *
