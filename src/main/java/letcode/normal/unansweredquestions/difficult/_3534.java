 ...
 * Difficulty: Hard
 * Link: https://leetcode.cn/problems/path-existence-queries-in-a-graph-ii/
 *
 ...
 *
 * You are also given a 2D integer array queries . For each queries[i] = [u i , v i ] , find the
 * minimum distance between nodes u i and v i . If no path exists between the two nodes, return -1 for
 * that query.
 *
