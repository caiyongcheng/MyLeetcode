 ...
 */
public class _2965TwoThousandNineHundredSixtyFive {
    ...
    public static void main(String[] args) {
        System.out.println(FormatUtils.formatArray(new _2965TwoThousandNineHundredSixtyFive().findMissingAndRepeatedValues(
