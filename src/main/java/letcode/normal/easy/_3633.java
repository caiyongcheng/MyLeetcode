 ...
 * Difficulty: Easy
 * Link: https://leetcode.cn/problems/earliest-finish-time-for-land-and-water-rides-i/
 ...
 * - Water rides - waterStartTime[j] &ndash; the earliest time the j th water ride can be boarded.
 * - waterDuration[j] &ndash; how long the j th water ride lasts. A touris...
 */
@SolutionTestMethod(method = "earliestFinishTime")
public class _3633 {
