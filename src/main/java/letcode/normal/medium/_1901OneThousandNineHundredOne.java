 ...
 */
public class _1901OneThousandNineHundredOne {

    public int[] findPeakGrid(int[][] mat) {
        // 实现做法不是题目要求的O(m log(n)) 或 O(n log(m))
        // O(m log(n)) 或 O(n log(m)) 的做法可以参考_162OneHundredSixtyTwo
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new _1901OneThousandNineHundredOne().findPeakGrid(
                TestCaseUtils.get2DIntArr("[[1,2,6],[3,4,5]]")
        )));
    }
