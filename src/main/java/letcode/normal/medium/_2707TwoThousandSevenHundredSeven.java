 ...
 */
public class _2707TwoThousandSevenHundredSeven {
    ...
    public int minExtraChar(String s, String[] dictionary) {
        ...
        假设已经计算出 si的最优解了 加上字符i+1时，如果尾部仍然在字典中 那么结果不变
    ...
    public static void main(String[] args) {
        System.out.println(new _2707TwoThousandSevenHundredSeven().minExtraChar(
                "leetscode",
                TestCaseUtils.getArrIgnoreDoubleQuote("[\"leet\",\"code\",\"leetcode\"]")
        ));
    }
