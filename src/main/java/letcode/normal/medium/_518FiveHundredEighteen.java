 ...
 */
public class _518FiveHundredEighteen {
    ...
    public static void main(String[] args) {
        System.out.println(new _518FiveHundredEighteen().change(
                5,
                TestCaseUtils.getIntArr("[1, 2, 5]")
        ));
        System.out.println(new _518FiveHundredEighteen().changeDp(
                5,
                TestCaseUtils.getIntArr("[1, 2, 5]")
        ));
        System.out.println(new _518FiveHundredEighteen().changeDp2(
                5,
                TestCaseUtils.getIntArr("[1, 2, 5]")
        ));
    }
