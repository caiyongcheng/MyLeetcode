 ...
 */
public class _1222OneThousandTwoHundredTwentyTwo {
    ...
    public static void main(String[] args) {
        System.out.println(FormatUtils.formatNextList(new _1222OneThousandTwoHundredTwentyTwo().queensAttackTheKing(
