 ...
 */
public class _2385TwoThousandThreeHundredEightyFive {
    ...
    public static void main(String[] args) {
        System.out.println(new _2385TwoThousandThreeHundredEightyFive().amountOfTime(
                TreeNode.createUseLeetCode(
                        TestCaseUtils.getIntegerArr("[1,5,3,null,4,10,6,9,2]")
                ),
                3
        ));
    }
