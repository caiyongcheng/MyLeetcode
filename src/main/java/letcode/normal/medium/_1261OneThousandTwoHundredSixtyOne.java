 ...
 */
public class _1261OneThousandTwoHundredSixtyOne {
    ...
    public _1261OneThousandTwoHundredSixtyOne(TreeNode root) {
        this.root = root;
    ...
    public static void main(String[] args) {
        _1261OneThousandTwoHundredSixtyOne test = new _1261OneThousandTwoHundredSixtyOne(TreeNode.createUseLeetCode(TestCaseUtils.getIntegerArr(
                "[-1,null,-1,-1,null,-1]"
        )));
