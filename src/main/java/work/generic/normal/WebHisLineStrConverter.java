 ...
 */
public class WebHisLineStrConverter {
    ...
    public static void init(String tableName, String tableComment, String tableColumnInfoStr) {
        WebHisTableInfoParser.setOriginalTableColumnInfo(tableColumnInfoStr);
    ...
    private static void addStrConverter(String tableName, String tableComment, String downFirstWordHumpName, String tableHumpName) {
        ...
        nameMap.put("dto字段说明", WebHisTableInfoParser.getDTOColumnStr());
        nameMap.put("vo字段说明", WebHisTableInfoParser.getVOColumnStr());
        nameMap.put("do字段说明", WebHisTableInfoParser.getDoColumnStr());
        nameMap.put("domain字段说明", WebHisTableInfoParser.getDomainColumnStr());
        nameMap.put("voConverter语句", WebHisTableInfoParser.getVOConverter(downFirstWordHumpName + "VO", downFirstWordHumpName));
        nameMap.put("dto2domain语句", WebHisTableInfoParser.getDTO2DomainConverter(downFirstWordHumpName + "DTO", downFirstWordHumpName));
        nameMap.put("mergeNewAndOld语句", WebHisTableInfoParser.getMergeConverter("old" + tableHumpName, "new" + tableHumpName));
        nameMap.put("domain2do语句", WebHisTableInfoParser.getMergeConverter(downFirstWordHumpName + "DO", downFirstWordHumpName));
        nameMap.put("do2domain语句", WebHisTableInfoParser.getMergeConverter(downFirstWordHumpName, downFirstWordHumpName + "DO" ));
        nameMap.put("当前时间", LocalDateTime.now().format(DATE_TIME_FORMATTER));
    }
